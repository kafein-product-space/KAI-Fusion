                ...
                <table className="w-full text-sm p-2 overflow-hidden">
                  ...
                  <tbody>
                    {filteredWorkflows.map((workflow) => (
                      <tr key={workflow.id} className="border-b border-gray-300 hover:bg-gray-50">
                        <td className="p-6">
                        ...
                        <td className="p-6 relative">
                          {/* DaisyUI Dropdown */}
                             ...
                             <div
                               tabIndex={0}
                               role="button"
                               className={`btn btn-ghost btn-sm p-2 ${isDeleting === workflow.id ? 'opacity-50 cursor-not-allowed' : ''}`}
                             >
                            ...
                            >
                              ...
                              <li>
                                <a onClick={() => navigator.clipboard.writeText(workflow.id)}>
                              ...
                              <li>
                                <a>
                                  ...
                                  Share
                                                             ...
                                                             <li>
                                 <a
                                   className={`text-red-600 hover:bg-red-50 ${isDeleting === workflow.id ? 'opacity-50 cursor-not-allowed' : ''}`}
                                   onClick={() => isDeleting === workflow.id ? null : handleDelete(workflow)}
                                 >
