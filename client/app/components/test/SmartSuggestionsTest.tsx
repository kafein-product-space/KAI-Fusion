...
const SmartSuggestionsTest: React.FC = () => {
  ...
  const testNodes = [
    ...
    { name: "RetrieverNode", display_name: "Retriever", category: "tools" },
    { name: "OpenAIChat", display_name: "OpenAI Chat", category: "llms" },
    { name: "EndNode", display_name: "End Node", category: "special" },
  ];
