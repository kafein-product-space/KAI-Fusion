...
const nodeTypeIconMap: Record<string, ReactElement> = {
  ...
  BufferMemory: <Archive />,
  ConversationMemory: <MessageCircle />,
  SummaryMemory: <Notebook />,
  AgentPrompt: <Settings2 />,
  PromptTemplate: <PenLine />,
  PDFLoader: (
    <svg
      width="20px"
      height="20px"
  ...
  WebLoader: <Link2 />,
  PydanticOutputParser: <SquareCode />,
  StringOutputParser: <Text />,
  ChromaRetriever: <DatabaseZap />,
  CharacterTextSplitter: <SplitSquareHorizontal />,
  RecursiveTextSplitter: <Repeat />,
  TokenTextSplitter: <Binary />,
  ArxivTool: <FileTextIcon />,
  WriteFileTool: <FilePen />,
  GoogleSearchTool: <Search />,
  JSONParser: <Braces />,
  RequestsGetTool: <ArrowDownToLine />,
  RequestsPostTool: <ArrowUpToLine />,
  TavilySearch: <Sparkles />,
  WebBrowserTool: <Globe />,
  WikipediaTool: <BookOpen />,
  ReadFileTool: <FileText />,
  WolframAlphaTool: <Calculator />,
  SitemapLoader: <Link2 />,
  YoutubeLoader: (
    <svg
      height="30px"
