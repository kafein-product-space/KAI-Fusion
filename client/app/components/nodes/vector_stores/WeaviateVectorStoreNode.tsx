...
interface WeaviateVectorStoreNodeProps {
  data: any;
  id: string;
}

function WeaviateVectorStoreNode({ data, id }: WeaviateVectorStoreNodeProps) {
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <p className="font-semibold">
              {data?.displayName || data?.name || "Weaviate Vector Store"}
            </p>
          </div>
        </div>
        {/*embeddings */}
...
export default WeaviateVectorStoreNode;
