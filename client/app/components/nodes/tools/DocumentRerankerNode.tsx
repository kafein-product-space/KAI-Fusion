...
import DocumentRerankerConfigModal from "~/components/modals/tools/DocumentRerankerConfigModal";
import NeonHandle from "~/components/common/NeonHandle";

interface DocumentRerankerNodeProps {
  data: any;
  id: string;
}

function DocumentRerankerNode({ data, id }: DocumentRerankerNodeProps) {
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="absolute text-xs text-red-700 font-medium pointer-events-none whitespace-nowrap"
          style={{
            bottom: "-30%",
            transform: "translateY(-50%)",
          }}
        >
          {data?.displayName || data?.name || "Document Reranker"}
        </div>
...
export default DocumentRerankerNode;
