...
import { Settings, Database, Layers, Tag, Filter } from "lucide-react";
          ...
          <Form className="space-y-3 w-full p-3" onSubmit={handleSubmit}>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                />
                <p className="text-xs text-slate-400 mt-1">
                  Custom table prefix for complete database isolation (optional)
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3 pt-2 border-t border-slate-600/30">
              ...
              <JSONEditor
                ...
                onChange={(value) => setFieldValue("custom_metadata", value)}
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 ml-5">
                  Keep original document metadata alongside custom metadata
                </p>
                <ErrorMessage
                  name="preserve_document_metadata"
                  component="div"
