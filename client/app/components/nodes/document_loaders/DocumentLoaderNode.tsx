...
import DocumentLoaderConfigModal from "~/components/modals/document_loaders/DocumentLoaderConfigModal";
import NeonHandle from "~/components/common/NeonHandle";

interface DocumentLoaderNodeProps {
  data: any;
  id: string;
}

function DocumentLoaderNode({ data, id }: DocumentLoaderNodeProps) {
  ...
  const getFormatsCount = () => {
    return data.supported_formats?.length || 0;
  };
