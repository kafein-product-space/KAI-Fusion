...
import GitHubLoaderConfigModal from "~/components/modals/document_loaders/GitHubLoaderConfigModal";

interface GitHubLoaderNodeProps {
  data: any;
  id: string;
}

function GitHubLoaderNode({ data, id }: GitHubLoaderNodeProps) {
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <p className="font-semibold">
              {data?.displayName || data?.name || "GitHub Loader"}
            </p>
          </div>
        </div>
...
export default GitHubLoaderNode;
