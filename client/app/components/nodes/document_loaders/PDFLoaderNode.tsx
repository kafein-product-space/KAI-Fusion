...
interface PDFLoaderNodeProps {
  data: any;
  id: string;
}

function PDFLoaderNode({ data, id }: PDFLoaderNodeProps) {
      ...
      >
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <p className="font-semibold">{data?.name || "PDF Loader"}</p>
          </div>
        </div>
