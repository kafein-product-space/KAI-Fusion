...
interface SitemapLoaderNodeProps {
  data: any;
  id: string;
}

function SitemapLoaderNode({ data, id }: SitemapLoaderNodeProps) {
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <p className="font-semibold">
              {data?.displayName || data?.name || "Sitemap Loader"}
            </p>
          </div>
        </div>
...
export default SitemapLoaderNode;
