...
import TextFormatterConfigModal from "~/components/modals/utilities/TextFormatterConfigModal";
...
function TextFormatterNode({ data, id }: TextFormatterNodeProps) {
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <p className="font-semibold">
              {data?.displayName || data?.name || "Text Formatter"}
            </p>
          </div>
        </div>
