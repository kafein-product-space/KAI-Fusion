...
>(({ nodeData, onSave, nodeId }, ref) => {
  ...
  const [model, setModel] = useState(nodeData?.model || "text-embedding-3-small");
  const [requestTimeout, setRequestTimeout] = useState(nodeData?.request_timeout || 60);
  ...
  return (
    <dialog ref={dialogRef} className="modal modal-bottom sm:modal-middle">
      <div className="modal-box">
        <h3 className="font-bold text-lg">Configure OpenAI Embeddings Provider</h3>
