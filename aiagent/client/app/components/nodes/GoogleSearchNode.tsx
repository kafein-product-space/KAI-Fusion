...
import ClaudeConfigModal from "../modals/ClaudeConfigModal";
import BufferMemoryConfigModal from "../modals/BufferMemoryConfigModal";
import AgentPromptConfigModal from "../modals/AgentPromptConfigModal";
import ArxivToolConfigModal from "../modals/ArxivToolConfigModal";
import FileToolConfigModal from "../modals/FileToolConfigModal";
import GoogleSearchToolModal from "../modals/GoogleSearchToolModal";

interface GoogleSearchNodeProps {
  data: any;
  id: string;
}

function GoogleSearchNode({ data, id }: GoogleSearchNodeProps) {
