...
interface ChromaRetrieverNodeProps {
  data: any;
  id: string;
}

function ChromaRetrieverNode({ data, id }: ChromaRetrieverNodeProps) {
...
export default ChromaRetrieverNode;
