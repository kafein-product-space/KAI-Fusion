...
interface ArxivToolNodeProps {
  data: any;
  id: string;
}

function ArxivToolNode({ data, id }: ArxivToolNodeProps) {
      ...
      >
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <p className="font-semibold">{data?.name || "Agent Prompt"}</p>
          </div>
        </div>
