...
import RequestsPostToolModal from "../modals/RequestsPostToolModal";
...
function RequestsPostToolNode({ data, id }: RequestsPostToolNodeProps) {
      ...
      >
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <p className="font-semibold">{data?.name || "RequestsPostTool"}</p>
          </div>
        </div>
...
export default RequestsPostToolNode;
