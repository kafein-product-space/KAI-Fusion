...
import SummaryMemoryConfigModal from "../modals/SummaryMemoryConfigModal";
import StringOutputParserConfigModal from "../modals/StringOutputParserConfigModal";
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <p className="font-semibold">
              {data?.name || "String Output Parser"}
            </p>
          </div>
        </div>
