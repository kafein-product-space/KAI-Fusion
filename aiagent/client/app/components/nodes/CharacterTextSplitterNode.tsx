...
import ChromaRetrieverConfigModal from "../modals/ChromaRetrieverConfigModal";
import CharacterTextSplitterConfigModal from "../modals/CharacterTextSplitterConfigModal";

interface CharacterTextSplitterNodeProps {
  data: any;
  id: string;
}

function CharacterTextSplitterNode({
  data,
  id,
}: CharacterTextSplitterNodeProps) {
  ...
  return (
    <>
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <p className="font-semibold">
              {data?.name || "Character Text Splitter"}
            </p>
          </div>
        </div>
      ...
      <CharacterTextSplitterConfigModal
        ref={modalRef}
        nodeData={data}
